...
import { FaTwitter, FaGithub, FaBook, FaRegSmileBeam, FaHeart } from "react-icons/fa";
        ...
        <div className={`section ${styles.personal}`}>
          ...
          >
            <motion.div variants={item} className={styles.personalCard}>
              ...
              <p>
              <strong>興味と好奇心の塊です</strong><br/>
              興味関心を持ったものは、やらない以外にない！そしてやるときめたら最後までとことん知りたい！経験したい！という性格です。
              ページトップにも書いた通り、不可能なことはないと考えています。<strong>人間は努力次第で自分の想像を超えられるし、その先にまた新しい可能性が待っている</strong>と思っています。
              </p>
            </motion.div>
            <motion.div variants={item} className={styles.personalCard}>
              <motion.div
              ...
              <p>
                <strong>勉強すること、新しい刺激が好きです</strong><br/>
                私が勉強で心掛けている3点は...<br/>
                【 <strong>1. 絶対に１日１つアウトプット</strong>】<br/>
                いいインプットがあってこそアウトプットができるし、アウトプットできてこそ定着!<br/>
                【 <strong>2. 理論の理解</strong>】<br/>
                &quot;<strong>なぜ、何のために??</strong>&quot;
                なんでこの言語が生まれたのか？<strong>意味や経緯、歴史</strong>を探っていくことで適切なコードをかけるようになると思うし、応用できる知識にするためにも、必須だと思っています。他の言語学ぶ時も入ってきやすいです。<br/>
                【 <strong>3. なんでもやってみる！</strong>】<br/>
                失敗してこそ学びが大きい!<strong>やってみてこそわかることの情報量が多い！</strong>やってみない理由なんてある？❤︎
              </p>
            ...
            <motion.div variants={item} className={styles.personalCard}>
              ...
              <p>
              <strong>コミュニケーションが好きです</strong><br/>
              前職は<strong>鍼灸師</strong>をしており、常に相手のニーズを探りながら背景を踏まえてベストな答えを出すことを心がけておりました。<br/>開発も好きですが、やはり人とお話しすることがとても好きです。
              <strong>様々な人の考えや、経験に触れながら協力することでこそ、学びも発想も人生も！より深まる</strong>と考えているので、ぜひ一緒に頑張りましょう！
              </p>
            </motion.div>
          </motion.div>
          ...
          >
            <motion.div variants={item} className={styles.skillCard}>
              ...
              <p>
                ...
                <br/>
                以下で表示しているポートフォリオ<br/>&quot;Together&quot;は<br/>Ruby on Railsで製作いたしました。
            ...
            <motion.div variants={item} className={styles.skillCard}>
              ...
              <strong>■ REACT</strong> -学習中<br/>
              <strong>■ Next.js</strong> -学習中<br/>
            ...
            <motion.div variants={item} className={styles.skillCard}>
              ...
              <br/>
              基本的なVPC, EC2, IAM, AMI, S3, RDS...<br/>などです。<br/>
